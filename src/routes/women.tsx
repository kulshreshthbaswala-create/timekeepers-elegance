...
export const Route = createFileRoute("/women")({
  ...
  head: () => ({
    meta: [
      { title: "Women's Watches — TWC Watches" },
      { name: "description", content: "Discover TWC Watches for women — elegant, limited edition timepieces including the Aurelia diamond-set rose gold watch." },
      { property: "og:title", content: "Women's Watches — TWC Watches" },
      { property: "og:description", content: "Elegant limited edition timepieces for women. Swiss-inspired craftsmanship." },
      ...
      <main>
        <section className="relative overflow-hidden bg-black py-24 md:py-32">
          <div className="mx-auto max-w-[1600px] px-6 md:px-10">
            <p className="eyebrow mb-6">For Her</p>
            ...
            <p className="text-white/60 max-w-xl mb-12 font-light">
              Timepieces designed to captivate — refined silhouettes, diamond-set details, and timeless grace.
            </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Link to="/products/$slug" params={{ slug: "aurelia" }} className="group relative bg-[#0c0c0c] border border-white/5 hover:border-gold/30 transition-all duration-500">
                ...
                <div className="p-6 text-center">
                  <h3 className="font-serif text-2xl text-white mb-1">Aurelia</h3>
                  ...
                  <div className="flex items-baseline justify-center gap-2 mb-5">
                    ...
                    <span className="text-xs text-muted-foreground line-through">₹1,04,000</span>
                  </div>
